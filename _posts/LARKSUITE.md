...
| Report Date      | Title | Severity     |
| :---        |    :----:   |          ---: |
| Nov 04-2020      | Accessing/Editing Folders of Other Users in the Orginisation       | High  |
| Oct 10   | Privilege Escalation to All-staff group (editing/accessing/deleting All-staff group)       | Medium      |
| Oct ran-10   | Viewer is able to leak the previous versions of the file      | Medium      |
| Oct-11-ran   | User without permission can download file's even if it's restricted.       | Medium      |
| Oct-11-ran   | IDOR allows viewer to delete bin's files of Admin       | Medium      |
| Oct-11-ran    | Bypassing Required Validation on Survey Questions     | Low      |
